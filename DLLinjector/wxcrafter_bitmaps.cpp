...
static unsigned char xml_res_file_0[] = { 60, 63, 120, 109, 108, 32, 118, 101, 114, 115, 105, 111, 110, 61, 34, 49, 46,
    ...
    79, 78, 32, 45, 45, 62, 10, 60, 47, 114, 101, 115, 111, 117, 114, 99, 101, 62, 10 };
...
void wxC9ED9InitBitmapResources()
{
    ...
    XRC_ADD_FILE(
        wxT("XRC_resource/wxcrafter_bitmaps.cpp$_Users_gabrielandrus_Documents_DLLinjector_wxcrafter_bitmaps.xrc"),
        xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT(
        "memory:XRC_resource/wxcrafter_bitmaps.cpp$_Users_gabrielandrus_Documents_DLLinjector_wxcrafter_bitmaps.xrc"));
}
